...
namespace WSH.UI
{
    ...
    public class UI_Canvas_Tabs : CanvasBase
    {
        ...
        public override void Initialize()
        {
            ...
            {
                TryGetUIElement(((TabButtonElements)i).ToString(), out tmpButton);
            ...
            {
                TryGetPanel(((TabPanelElements)i).ToString(), out tmpPanel);
                tabs.Add(tmpPanel);
            }
            ...
            TryGetUIElement("Button_CloseTab", out closeButton);
